...
const showCurrentBalance = (balance) => console.log(`Your current balance is now Rs.${balance}`);
function atm() {
    const pin = 1153;
    let deposit, withdraw, choice, anotherTransaction = '', amount = 5000;
    ...
    do {
        ...
        if (choice !== 4)
            anotherTransaction = prompt(`Press 'y' to go back to the main menu or any key to exit: `);
        else
            break;
        console.clear();
